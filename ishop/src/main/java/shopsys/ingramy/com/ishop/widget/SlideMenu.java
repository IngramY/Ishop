...
import shopsys.ingramy.com.ishop.util.StatusBarCompat;
...
public class SlideMenu extends ViewGroup {
	...
	private boolean mLocked; // 现已被改为是否展示侧边栏，而不是是否响应手势
	...
	public SlideMenu(Context context, AttributeSet attrs, int defStyle) {
		...
		StatusBarCompat.compat((Activity) context);
...
//		final int width = menuView.getLayoutParams().width;
		int width = menuView.getLayoutParams().width;
		if(mLocked) {
			width = 0;
		}
